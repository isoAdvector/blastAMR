...
namespace Foam
{
    defineTypeNameAndDebug(newCellCuts, 0);
...
Foam::label Foam::newCellCuts::findPartIndex
(
...
Foam::boolList Foam::newCellCuts::expand
(
    const label size,
...
Foam::scalarField Foam::newCellCuts::expand
(
    const label size,
    const labelList& labels,
...
Foam::label Foam::newCellCuts::firstUnique
(
    const labelList& lst,
    const Map<label>& map
)
...
void Foam::newCellCuts::syncProc()
{
    if (!Pstream::parRun())
    {
        return;
...
void Foam::newCellCuts::writeUncutOBJ
(
    const fileName& dir,
    const label celli
) const
...
void Foam::newCellCuts::writeOBJ
(
    const fileName& dir,
    const label celli,
...
Foam::label Foam::newCellCuts::edgeEdgeToFace
(
    const label celli,
    const label edgeA,
    const label edgeB
...
Foam::label Foam::newCellCuts::edgeVertexToFace
(
    const label celli,
    const label edgeI,
    const label vertI
...
Foam::label Foam::newCellCuts::vertexVertexToFace
(
    const label celli,
    const label vertA,
    const label vertB
...
void Foam::newCellCuts::calcFaceCuts() const
{
...
Foam::label Foam::newCellCuts::findEdge
(
    const label facei,
    const label v0,
    const label v1
...
Foam::label Foam::newCellCuts::loopFace
(
    const label celli,
...
bool Foam::newCellCuts::walkPoint
(
    const label celli,
...
bool Foam::newCellCuts::crossEdge
(
    const label celli,
    const label startCut,
    const label facei,
...
bool Foam::newCellCuts::walkFace
(
    const label celli,
    const label startCut,
    const label facei,
...
bool Foam::newCellCuts::walkCell
(
    const label celli,
    const label startCut,
    const label facei,
...
void Foam::newCellCuts::calcCellLoops(const labelList& cutCells)
{
...
void Foam::newCellCuts::walkEdges
(
    const label celli,
    const label pointi,
    const label status,
...
Foam::labelList Foam::newCellCuts::nonAnchorPoints
(
...
bool Foam::newCellCuts::loopAnchorConsistent
(
    const label celli,
...
bool Foam::newCellCuts::calcAnchors
(
    const label celli,
    const labelList& loop,
    const pointField& loopPts,
...
Foam::pointField Foam::newCellCuts::loopPoints
(
    const labelList& loop,
...
Foam::scalarField Foam::newCellCuts::loopWeights(const labelList& loop) const
{
...
bool Foam::newCellCuts::validEdgeLoop
(
    const labelList& loop,
    const scalarField& loopWeights
) const
...
Foam::label Foam::newCellCuts::countFaceCuts
(
    const label facei,
    const labelList& loop
) const
...
bool Foam::newCellCuts::conservativeValidLoop
(
    const label celli,
    const labelList& loop
) const
...
bool Foam::newCellCuts::validLoop
(
    const label celli,
    const labelList& loop,
    const scalarField& loopWeights,
...
void Foam::newCellCuts::setFromCellLoops()
{
...
bool Foam::newCellCuts::setFromCellLoop
(
    const label celli,
    const labelList& loop,
    const scalarField& loopWeights
...
void Foam::newCellCuts::setFromCellCutter
(
...
(
    const cellLooper& cellCutter,
    const labelList& cellLabels,
    const PtrList<plane>& cellCutPlanes
)
{
    // 'Uncut' edges/vertices that are not used in loops.
    pointIsCut_ = false;
...
void Foam::newCellCuts::orientPlanesAndLoops()
{
...
void Foam::newCellCuts::calcLoopsAndAddressing(const labelList& cutCells)
{
...
void Foam::newCellCuts::check() const
{
...
void Foam::newCellCuts::clearOut()
{
    faceCutsPtr_.clear();
}
...
Foam::pointField Foam::newCellCuts::loopPoints(const label celli) const
{
    const labelList& loop = cellLoops_[celli];
...
void Foam::newCellCuts::flip(const label celli)
{
    labelList& loop = cellLoops_[celli];
...
void Foam::newCellCuts::flipLoopOnly(const label celli)
{
    labelList& loop = cellLoops_[celli];
...
void Foam::newCellCuts::writeOBJ(Ostream& os) const
{
    label vertI = 0;
...
void Foam::newCellCuts::writeCellOBJ(const fileName& dir, const label celli) const
{
    const labelList& anchors = cellAnchorPoints_[celli];
