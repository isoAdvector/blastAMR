...
namespace Foam
{
    defineTypeNameAndDebug(hexRef3D, 0);
    addToRunTimeSelectionTable(hexRef, hexRef3D, mesh);
    addToRunTimeSelectionTable(hexRef, hexRef3D, levelsHist);
    addToRunTimeSelectionTable(hexRef, hexRef3D, levels);
}
...
Foam::label Foam::hexRef3D::getAnchorCell
(
...
Foam::label Foam::hexRef3D::storeMidPointInfo
(
    const labelListList& cellAnchorPoints,
    const labelListList& cellAddedCells,
...
void Foam::hexRef3D::createInternalFaces
(
    const labelListList& cellAnchorPoints,
    const labelListList& cellAddedCells,
    const labelList& cellMidPoint,
...
Foam::hexRef3D::hexRef3D(const polyMesh& mesh, const bool readHistory)
:
...
Foam::labelListList Foam::hexRef3D::setRefinement
(
...
)
{
    ...
    if (debug)
    {
        ...
        Pout<< "hexRef3D::setRefinement : Dumping " << splitCells.size()
    ...
    if (debug)
    {
        ...
        Pout<< "hexRef3D::setRefinement : Dumping " << splitFaces.size()
    ...
    if (debug)
    {
        Pout<< "hexRef3D::setRefinement : Splitting faces" << endl;
    }
...
Foam::labelList Foam::hexRef3D::consistentUnrefinement
(
...
) const
{
    if (debug)
    {
        Pout<< "hexRef3D::consistentUnrefinement :"
    ...
    // For hexRef3D, unrefinement is based on points
...
void Foam::hexRef3D::setUnrefinement
(
...
)
{
    ...
    if (debug)
    {
        ...
        Pout<< "hexRef3D::setRefinement : Dumping " << pSet.size()
            << " points and "
...
void Foam::hexRef3D::calcFaceToSplitPoint
(
...
)
{
    ...
    // For hexRef3D, the split elems are points
...
Foam::labelList Foam::hexRef3D::getSplitElems() const
{
    if (debug)
    {
        checkRefinementLevels(-1, labelList(0));
